...
echo "STIG ID: RHEL-07-010010 Rule ID: SV-86473r2_rule Vuln ID: V-71849
...
rpm -Va | grep '^.M'
echo "___________________________________________________________________________________________________________________"
echo "STIG ID:	RHEL-07-010020 Rule ID: SV-86479r2_rule Vuln ID: V-71855
...
rpm -Va | grep '^..5'
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010030 Rule ID: SV-86483r2_rule Vuln ID: V-71859
...
grep banner-message-enable /etc/dconf/db/local.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010040 Rule ID: SV-86485r2_rule Vuln ID: V-71861
Verify the operating system displays the approved Standard Mandatory DoD Notice and Consent Banner before granting access
to the operating system via a graphical user logon.
Note: If the system does not have GNOME installed, this requirement is Not Applicable.
Check that the operating system displays the exact approved Standard Mandatory DoD Notice and Consent Banner text with 
the command:
...
grep banner-message-text /etc/dconf/db/local.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010050 Rule ID: SV-86487r1_rule Vuln ID: V-71863
Verify the operating system displays the Standard Mandatory DoD Notice and Consent Banner before granting access to the 
...
more /etc/issue
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010060 Rule ID: SV-86515r3_rule Vuln ID: V-71891
Verify the operating system enables a user's session lock until that user re-establishes access using established 
identification and authentication procedures. The screen program must be installed to lock sessions on the console.
Note: If the system does not have GNOME installed, this requirement is Not Applicable.
...
grep -i lock-enabled /etc/dconf/db/local.d/00-screensaver
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010070 Rule ID: SV-86517r3_rule Vuln ID: V-71893
...
grep -i idle-delay /etc/dconf/db/local.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010080 Rule ID: SV-86519r3_rule Vuln ID: V-71895
...
grep -i idle-delay /etc/dconf/db/local.d/locks/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010090 Rule ID: SV-86521r1_rule Vuln ID: V-71897
...
yum list installed | grep screen
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010100 Rule ID: SV-86523r1_rule Vuln ID: V-71899
...
The screen program must be installed to lock sessions on the console.
If it is installed, GNOME must be configured to enforce a session lock after a 15-minute delay. Check for the session lock 
settings with the following commands:
...
grep -i idle_activation_enabled /etc/dconf/db/local.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010110 Rule ID: SV-86525r1_rule Vuln ID: V-71901
...
grep -i lock-delay /etc/dconf/db/local.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010120 Rule ID: SV-86527r2_rule Vuln ID: V-71903
...
grep ucredit /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010130 Rule ID: SV-86529r3_rule Vuln ID: V-71905
...
grep lcredit /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010140 Rule ID: SV-86531r2_rule Vuln ID: V-71907
...
grep dcredit /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010150 Rule ID: SV-86533r1_rule Vuln ID: V-71909
...
grep ocredit /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010160 Rule ID: SV-86535r1_rule Vuln ID: V-71911
...
grep difok /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010170 Rule ID: SV-86537r1_rule Vuln ID: V-71913
...
grep minclass /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010180 Rule ID: SV-86539r1_rule Vuln ID: V-71915
...
grep maxrepeat /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010190 Rule ID: SV-86541r1_rule Vuln ID: V-71917
...
grep maxclassrepeat /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010200 Rule ID: SV-86543r1_rule Vuln ID: V-71919
...
grep password /etc/pam.d/system-auth-ac
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010210 Rule ID: SV-86545r1_rule Vuln ID: V-71921
...
grep -i encrypt /etc/login.defs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010220 Rule ID: SV-86547r2_rule Vuln ID: V-71923
...
cat /etc/libuser.conf | grep -i sha512
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010230 Rule ID: SV-86549r1_rule Vuln ID: V-71925
...
grep -i pass_min_days /etc/login.defs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010240 Rule ID: SV-86551r1_rule Vuln ID: V-71927
...
awk -F: '$4 < 1 {print $1}' /etc/shadow
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010250 Rule ID: SV-86553r1_rule Vuln ID: V-71929
...
grep -i pass_max_days /etc/login.defs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010260 Rule ID: SV-86555r1_rule Vuln ID: V-71931
...
awk -F: '$5 > 60 {print $1}' /etc/shadow
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010270 Rule ID: SV-86557r1_rule Vuln ID: V-71933
...
grep -i remember /etc/pam.d/system-auth-ac
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010280 Rule ID: SV-86559r1_rule Vuln ID: V-71935
...
grep minlen /etc/security/pwquality.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010290 Rule ID: SV-86561r1_rule Vuln ID: V-71937
...
grep nullok /etc/pam.d/system-auth-ac
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010300 Rule ID: SV-86563r2_rule Vuln ID: V-71939
...
grep -i PermitEmptyPasswords /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010310 Rule ID: SV-86565r1_rule Vuln ID: V-71941
...
grep -i inactive /etc/default/useradd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010320 Rule ID: SV-86567r2_rule Vuln ID: V-71943
Verify the operating system automatically locks an account for the maximum period for which the system can be configured.
Check that the system locks an account for the maximum period after three unsuccessful logon attempts within a period of 
15 minutes with the following command:
...
If the 'unlock_time' setting is greater than '604800' on both lines with the 'pam_faillock.so' module name or is missing 
from a line, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
grep pam_faillock.so /etc/pam.d/password-auth-ac
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010330 Rule ID: SV-86569r1_rule Vuln ID: V-71945
Verify the operating system automatically locks the root account until it is released by an administrator when three 
...
grep pam_faillock.so /etc/pam.d/password-auth-ac
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010340 Rule ID: SV-86571r1_rule Vuln ID: V-71947
...
grep -i nopasswd /etc/sudoers /etc/sudoers.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010350 Rule ID: SV-86573r2_rule Vuln ID: V-71949
...
grep -i authenticate /etc/sudoers /etc/sudoers.d/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010430 Rule ID: SV-86575r1_rule Vuln ID: V-71951
...
grep -i fail_delay /etc/login.defs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010440 Rule ID: SV-86577r1_rule Vuln ID: V-71953
...
grep -i automaticloginenable /etc/gdm/custom.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010450 Rule ID: SV-86579r2_rule Vuln ID: V-71955
...
grep -i timedloginenable /etc/gdm/custom.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010460 Rule ID: SV-86581r2_rule Vuln ID: V-71957
...
grep -i permituserenvironment /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010470 Rule ID: SV-86583r2_rule Vuln ID: V-71959
...
grep -i hostbasedauthentication /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010480 Rule ID: SV-86585r2_rule Vuln ID: V-71961
...
grep -i ^password_pbkdf2 /boot/grub2/grub.cfg
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010490 Rule ID: SV-86587r1_rule Vuln ID: V-71963
...
grep -i password /boot/efi/EFI/redhat/grub.cfg
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010500 Rule ID: SV-86589r1_rule Vuln ID: V-71965
...
authconfig --test | grep -i smartcard
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020000 Rule ID: SV-86591r1_rule Vuln ID: V-71967
...
yum list installed rsh-server
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020010 Rule ID: SV-86593r1_rule Vuln ID: V-71969
...
yum list installed ypserv
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020020 Rule ID: SV-86595r1_rule Vuln ID: V-71971
...
semanage login -l | more
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020030 Rule ID: SV-86597r1_rule Vuln ID: V-71973
...
subdirectories, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
yum list installed aide
ls -al /etc/cron.* | grep aide
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020040 Rule ID: SV-86599r1_rule Vuln ID: V-71975
...
ls -al /etc/cron.daily | grep aide
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020050 Rule ID: SV-86601r1_rule Vuln ID: V-71977
...
grep gpgcheck /etc/yum.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020060 Rule ID: SV-86603r1_rule Vuln ID: V-71979
...
grep localpkg_gpgcheck /etc/yum.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020070 Rule ID: SV-86605r1_rule Vuln ID: V-71981
Verify the operating system prevents the installation of patches, service packs, device drivers, or operating system 
...
grep repo_gpgcheck /etc/yum.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020100 Rule ID: SV-86607r2_rule Vuln ID: V-71983
...
is not documented with the Information System Security Officer (ISSO) as an operational requirement, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
grep usb-storage /etc/modprobe.d/blacklist.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020110 Rule ID: SV-86609r1_rule Vuln ID: V-71985
...
systemctl status autofs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020200 Rule ID: SV-86611r1_rule Vuln ID: V-71987
...
grep -i clean_requirements_on_remove /etc/yum.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020210 Rule ID: SV-86613r2_rule Vuln ID: V-71989
...
getenforce
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020220 Rule ID: SV-86615r2_rule Vuln ID: V-71991
Verify the operating system verifies correct operation of all security functions.
...
sestatus
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020230 Rule ID: SV-86617r1_rule Vuln ID: V-71993
...
systemctl status ctrl-alt-del.service
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020240 Rule ID: SV-86619r1_rule Vuln ID: V-71995
...
grep -i umask /etc/login.defs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020250 Rule ID: SV-86621r2_rule Vuln ID: V-71997
...
cat /etc/redhat-release
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020260 Rule ID: SV-86623r3_rule Vuln ID: V-71999
...
yum history list | more
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020270 Rule ID: SV-86625r1_rule Vuln ID: V-72001
...
more /etc/passwd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020300 Rule ID: SV-86627r1_rule Vuln ID: V-72003
...
pwck -r
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020310 Rule ID: SV-86629r1_rule Vuln ID: V-72005
...
awk -F: '$3 == 0 {print $1}' /etc/passwd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020320 Rule ID: SV-86631r1_rule Vuln ID: V-72007
...
find / -xdev -fstype xfs -nouser
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020330 Rule ID: SV-86633r1_rule Vuln ID: V-72009
...
find / -xdev -fstype xfs -nogroup
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020600 Rule ID: SV-86635r1_rule Vuln ID: V-72011
...
cut -d: -f 1,3 /etc/passwd | egrep ":[1-4][0-9]{2}$|:[0-9]{1,2}$"
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020610 Rule ID: SV-86637r1_rule Vuln ID: V-72013
...
grep -i create_home /etc/login.defs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020620 Rule ID: SV-86639r1_rule Vuln ID: V-72015
...
pwck -r
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020630 Rule ID: SV-86641r2_rule Vuln ID: V-72017
...
ls -ld $(egrep ':[0-9]{4}' /etc/passwd | cut -d: -f6)
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020640 Rule ID: SV-86643r3_rule Vuln ID: V-72019
Verify the assigned home directory of all local interactive users on the system exists.
Check the home directory assignment for all local interactive non-privileged users on the system with the following command:
Note: This may miss interactive users that have been assigned a privileged UID. Evidence of interactive use may be obtained 
from a number of log files containing system logon information.
...
ls -ld $(egrep ':[0-9]{4}' /etc/passwd | cut -d: -f6)
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020650 Rule ID: SV-86645r3_rule Vuln ID: V-72021
...
grep users /etc/group
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020660 Rule ID: SV-86647r1_rule Vuln ID: V-72023
...
ls -lLR /home/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020670 Rule ID: SV-86649r1_rule Vuln ID: V-72025
...
cat /etc/group
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020680 Rule ID: SV-86651r1_rule Vuln ID: V-72027
...
ls -lLR /home/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020690 Rule ID: SV-86653r1_rule Vuln ID: V-72029
...
directory owner or root, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
ls -al /home/*/.* | more
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020700 Rule ID: SV-86655r2_rule Vuln ID: V-72031
...
ls -al /home/*/.*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020710 Rule ID: SV-86657r1_rule Vuln ID: V-72033
...
ls -al /home/*/.* | more
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020720 Rule ID: SV-86659r2_rule Vuln ID: V-72035
...
grep -i path /home/*/.*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020730 Rule ID: SV-86661r1_rule Vuln ID: V-72037
...
grep <file> /home/*/.*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-020900 Rule ID: SV-86663r1_rule Vuln ID: V-72039
...
find /dev -context *:unlabeled_t:* \( -type c -o -type b \) -printf "%p %Z\n"
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021000 Rule ID: SV-86665r2_rule Vuln ID: V-72041
Verify file systems that contain user home directories are mounted with the 'nosuid' option.
Find the file system(s) that contain the user home directories with the following command:
Note: If a separate file system has not been created for the user home directories (user home directories are mounted 
under '/'), this is not a finding as the 'nosuid' option cannot be used on the '/' system.
...
If a file system found in '/etc/fstab' refers to the user home directory file system and it does not have the 'nosuid' 
option set, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
cut -d: -f 1,6 /etc/passwd | egrep ":[1-4][0-9]{3}"
more /etc/fstab
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021010 Rule ID: SV-86667r1_rule Vuln ID: V-72043
...
more /etc/fstab
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021020 Rule ID: SV-86669r1_rule Vuln ID: V-72045
...
more /etc/fstab | grep nfs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021030 Rule ID: SV-86671r2_rule Vuln ID: V-72047
...
find / -xdev -perm -002 -type d -fstype xfs -exec ls -lLd {} \;
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021040 Rule ID: SV-86673r1_rule Vuln ID: V-72049
...
than '077', this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
grep -i umask /home/*/.*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021100 Rule ID: SV-86675r1_rule Vuln ID: V-72051
...
more /etc/rsyslog.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021110 Rule ID: SV-86677r2_rule Vuln ID: V-72053
...
ls -al /etc/cron.allow
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021120 Rule ID: SV-86679r1_rule Vuln ID: V-72055
...
ls -al /etc/cron.allow
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021300 Rule ID: SV-86681r1_rule Vuln ID: V-72057
...
systemctl status kdump.service
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021310 Rule ID: SV-86683r1_rule Vuln ID: V-72059
...
grep /home /etc/fstab
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021320 Rule ID: SV-86685r1_rule Vuln ID: V-72061
...
grep /var /etc/fstab
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021330 Rule ID: SV-86687r4_rule Vuln ID: V-72063
...
If a separate entry for /var/log/audit does not exist, ask the System Administrator (SA) if the system audit logs are 
being written to a different file system/partition on the system, then grep for that file system/partition.
If a separate file system/partition does not exist for the system audit data path, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
grep /var/log/audit /etc/fstab
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021340 Rule ID: SV-86689r1_rule Vuln ID: V-72065
...
systemctl is-enabled tmp.mount
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021350 Rule ID: SV-86691r2_rule Vuln ID: V-72067
...
cat /proc/sys/crypto/fips_enabled
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021600 Rule ID: SV-86693r2_rule Vuln ID: V-72069
...
find / -name aide.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021610 Rule ID: SV-86695r2_rule Vuln ID: V-72071
...
not being checked by another file integrity tool, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
yum list installed aide
find / -name aide.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021620 Rule ID: SV-86697r2_rule Vuln ID: V-72073
...
tool is not using FIPS 140-2 approved cryptographic hashes for validating file contents and directories, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
yum list installed aide
find / -name aide.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021700 Rule ID: SV-86699r1_rule Vuln ID: V-72075
...
grep ‘set root’ /boot/grub2/grub.cfg
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021710 Rule ID: SV-86701r1_rule Vuln ID: V-72077
...
yum list installed | grep telnet-server
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030000 Rule ID: SV-86703r1_rule Vuln ID: V-72079
...
systemctl is-active auditd.service
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030010 Rule ID: SV-86705r1_rule Vuln ID: V-72081
...
If the '-f' flag is set to '1' but the availability concern is not documented or there is no monitoring of the kernel log, 
this is a CAT III finding."
echo "-------------------------------------------------------------------------------------------------------------------"
auditctl -l | grep /-f
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030300 Rule ID: SV-86707r1_rule Vuln ID: V-72083
...
grep -i remote_server /etc/audisp/audisp-remote.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030310 Rule ID: SV-86709r1_rule Vuln ID: V-72085
...
grep -i enable_krb5 /etc/audisp/audisp-remote.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030320 Rule ID: SV-86711r2_rule Vuln ID: V-72087
...
grep -i network_failure_action /etc/audisp/audisp-remote.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030330 Rule ID: SV-86713r1_rule Vuln ID: V-72089
...
grep -i space_left /etc/audit/auditd.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030340 Rule ID: SV-86715r1_rule Vuln ID: V-72091
...
grep -i space_left_action /etc/audit/auditd.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030350 Rule ID: SV-86717r2_rule Vuln ID: V-72093
...
grep -i action_mail_acct /etc/audit/auditd.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030360 Rule ID: SV-86719r3_rule Vuln ID: V-72095
...
All 'setuid' and 'setgid' files on the system must have a corresponding audit rule, or must have an audit rule for the (sub) 
directory that contains the 'setuid'/'setgid' file.
...
grep <suid_prog_with_full_path> -a always,exit -F <suid_prog_with_full_path> -F perm=x -F auid>=1000 -F auid!=4294967295 -k setuid/setgid
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030370 Rule ID: SV-86721r2_rule Vuln ID: V-72097
...
grep -i chown /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030380 Rule ID: SV-86723r2_rule Vuln ID: V-72099
...
grep -i fchown /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030390 Rule ID: SV-86725r2_rule Vuln ID: V-72101
...
grep -i lchown /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030400 Rule ID: SV-86727r2_rule Vuln ID: V-72103
...
grep -i fchownat /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030410 Rule ID: SV-86729r2_rule Vuln ID: V-72105
...
grep -i chmod /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030420 Rule ID: SV-86731r2_rule Vuln ID: V-72107
...
grep -i fchmod /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030430 Rule ID: SV-86733r2_rule Vuln ID: V-72109
...
grep -i fchmodat /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030440 Rule ID: SV-86735r2_rule Vuln ID: V-72111
...
grep -i setxattr /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030450 Rule ID: SV-86737r2_rule Vuln ID: V-72113
...
grep -i fsetxattr /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030460 Rule ID: SV-86739r2_rule Vuln ID: V-72115
...
grep -i lsetxattr /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030470 Rule ID: SV-86741r2_rule Vuln ID: V-72117
...
grep -i removexattr /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030480 Rule ID: SV-86743r2_rule Vuln ID: V-72119
...
grep -i fremovexattr /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030490 Rule ID: SV-86745r2_rule Vuln ID: V-72121
...
grep -i lremovexattr /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030500 Rule ID: SV-86747r2_rule Vuln ID: V-72123
...
grep -i creat /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030510 Rule ID: SV-86749r2_rule Vuln ID: V-72125
...
grep -i open /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030520 Rule ID: SV-86751r2_rule Vuln ID: V-72127
...
grep -i openat /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030530 Rule ID: SV-86753r2_rule Vuln ID: V-72129
...
grep -i open_by_handle_at /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030540 Rule ID: SV-86755r2_rule Vuln ID: V-72131
...
grep -i truncate /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030550 Rule ID: SV-86757r2_rule Vuln ID: V-72133
...
grep -i ftruncate /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030560 Rule ID: SV-86759r3_rule Vuln ID: V-72135
...
grep -i /usr/sbin/semanage /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030570 Rule ID: SV-86761r3_rule Vuln ID: V-72137
...
grep -i /usr/sbin/setsebool /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030580 Rule ID: SV-86763r3_rule Vuln ID: V-72139
...
grep -i /usr/bin/chcon /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030590 Rule ID: SV-86765r3_rule Vuln ID: V-72141
...
grep -i /usr/sbin/restorecon /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030600 Rule ID: SV-86767r2_rule Vuln ID: V-72143
...
grep -i /var/log/tallylog /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030610 Rule ID: SV-86769r2_rule Vuln ID: V-72145
...
grep -i /var/run/faillock /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030620 Rule ID: SV-86771r2_rule Vuln ID: V-72147
...
grep -i /var/log/lastlog /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030630 Rule ID: SV-86773r3_rule Vuln ID: V-72149
...
grep -i /usr/bin/passwd /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030640 Rule ID: SV-86775r3_rule Vuln ID: V-72151
...
grep -i /sbin/unix_chkpwd /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030650 Rule ID: SV-86777r3_rule Vuln ID: V-72153
...
grep -i /usr/bin/gpasswd /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030660 Rule ID: SV-86779r3_rule Vuln ID: V-72155
...
grep -i /usr/bin/chage /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030670 Rule ID: SV-86781r3_rule Vuln ID: V-72157
...
grep -i /usr/sbin/userhelper /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030680 Rule ID: SV-86783r3_rule Vuln ID: V-72159
...
grep -i /bin/su /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030690 Rule ID: SV-86785r3_rule Vuln ID: V-72161
...
grep -i /usr/bin/sudo /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030700 Rule ID: SV-86787r3_rule Vuln ID: V-72163
...
Check for modification of the following files being audited by performing the following commands to check the file system 
...
grep /etc/sudoers.d /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030710 Rule ID: SV-86789r3_rule Vuln ID: V-72165
...
grep -i /usr/bin/newgrp /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030720 Rule ID: SV-86791r3_rule Vuln ID: V-72167
...
grep -i /usr/bin/chsh /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030730 Rule ID: SV-86793r3_rule Vuln ID: V-72169
...
grep -i /usr/bin/sudoedit /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030740 Rule ID: SV-86795r3_rule Vuln ID: V-72171
...
grep -i /bin/mount /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030750 Rule ID: SV-86797r3_rule Vuln ID: V-72173
...
grep -i /bin/umount /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030760 Rule ID: SV-86799r3_rule Vuln ID: V-72175
...
grep -i /usr/sbin/postdrop /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030770 Rule ID: SV-86801r2_rule Vuln ID: V-72177
...
grep -i /usr/sbin/postqueue /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030780 Rule ID: SV-86803r2_rule Vuln ID: V-72179
...
grep -i /usr/libexec/openssh/ssh-keysign /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030800 Rule ID: SV-86807r2_rule Vuln ID: V-72183
...
grep -i /usr/bin/crontab /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030810 Rule ID: SV-86809r2_rule Vuln ID: V-72185
...
grep -i /sbin/pam_timestamp_check /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030820 Rule ID: SV-86811r2_rule Vuln ID: V-72187
...
grep -i init_module /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030830 Rule ID: SV-86813r2_rule Vuln ID: V-72189
...
grep -i delete_module /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030840 Rule ID: SV-86815r2_rule Vuln ID: V-72191
...
grep -i insmod /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030850 Rule ID: SV-86817r2_rule Vuln ID: V-72193
...
grep -i rmmod /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030860 Rule ID: SV-86819r2_rule Vuln ID: V-72195
...
grep /etc/passwd /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030880 Rule ID: SV-86823r2_rule Vuln ID: V-72199
...
grep -i rename /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030890 Rule ID: SV-86825r2_rule Vuln ID: V-72201
...
grep -i renameat /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030900 Rule ID: SV-86827r2_rule Vuln ID: V-72203
...
grep -i rmdir /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030910 Rule ID: SV-86829r2_rule Vuln ID: V-72205
...
grep -i unlink/etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030920 Rule ID: SV-86831r2_rule Vuln ID: V-72207
...
grep -i unlinkat/etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-031000 Rule ID: SV-86833r1_rule Vuln ID: V-72209
...
grep @ /etc/rsyslog.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-031010 Rule ID: SV-86835r1_rule Vuln ID: V-72211
...
grep imtcp /etc/rsyslog.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-032000 Rule ID: SV-86837r1_rule Vuln ID: V-72213
...
systemctl status clamav-daemon.socket
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-032010 Rule ID: SV-86839r1_rule Vuln ID: V-72215
...
ls -al /var/lib/clamav/*.cvd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040000 Rule ID: SV-86841r1_rule Vuln ID: V-72217
...
grep "maxlogins" /etc/security/limits.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040100 Rule ID: SV-86843r1_rule Vuln ID: V-72219
...
services that are prohibited by the PPSM Category Assurance List (CAL), this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
firewall-cmd --list-all
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040110 Rule ID: SV-86845r2_rule Vuln ID: V-72221
...
grep -i ciphers /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040160 Rule ID: SV-86847r2_rule Vuln ID: V-72223
Verify the operating system terminates all network connections associated with a communications session at the end of 
the session or based on inactivity.
...
grep -i tmout /etc/bashrc
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040170 Rule ID: SV-86849r2_rule Vuln ID: V-72225
...
grep -i banner /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040180 Rule ID: SV-86851r2_rule Vuln ID: V-72227
...
grep -i ssl /etc/pam_ldap.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040190 Rule ID: SV-86853r2_rule Vuln ID: V-72229
...
grep -i cacertdir /etc/pam_ldap.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040200 Rule ID: SV-86855r2_rule Vuln ID: V-72231
Verify the operating system implements cryptography to protect the integrity of remote ldap access sessions.
To determine if LDAP is being used for authentication, use the following command:
...
grep -i cacertfile /etc/pam_ldap.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040300 Rule ID: SV-86857r1_rule Vuln ID: V-72233
...
yum list installed ssh
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040310 Rule ID: SV-86859r2_rule Vuln ID: V-72235
...
systemctl status sshd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040320 Rule ID: SV-86861r2_rule Vuln ID: V-72237
...
grep -i clientalive /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040330 Rule ID: SV-86863r3_rule Vuln ID: V-72239
...
grep RhostsRSAAuthentication /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040340 Rule ID: SV-86865r2_rule Vuln ID: V-72241
Verify the operating system automatically terminates a user session after inactivity time-outs have expired.
...
grep -i clientalivecount /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040350 Rule ID: SV-86867r2_rule Vuln ID: V-72243
...
grep -i IgnoreRhosts /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040360 Rule ID: SV-86869r2_rule Vuln ID: V-72245
...
grep -i printlastlog /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040370 Rule ID: SV-86871r2_rule Vuln ID: V-72247
...
grep -i permitrootlogin /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040380 Rule ID: SV-86873r2_rule Vuln ID: V-72249
Verify the SSH daemon does not allow authentication using known hosts authentication.
...
grep -i IgnoreUserKnownHosts /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040390 Rule ID: SV-86875r2_rule Vuln ID: V-72251
...
grep -i protocol /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040400 Rule ID: SV-86877r2_rule Vuln ID: V-72253
...
grep -i macs /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040410 Rule ID: SV-86879r1_rule Vuln ID: V-72255
...
find /etc/ssh -name '*.pub' -exec ls -lL {} \;
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040420 Rule ID: SV-86881r1_rule Vuln ID: V-72257
...
ls -lL /etc/ssh/*key
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040430 Rule ID: SV-86883r2_rule Vuln ID: V-72259
...
grep -i gssapiauth /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040440 Rule ID: SV-86885r2_rule Vuln ID: V-72261
...
grep -i kerberosauth /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040450 Rule ID: SV-86887r2_rule Vuln ID: V-72263
...
grep -i strictmodes /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040460 Rule ID: SV-86889r2_rule Vuln ID: V-72265
...
grep -i usepriv /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040470 Rule ID: SV-86891r2_rule Vuln ID: V-72267
...
grep -i compression /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040500 Rule ID: SV-86893r2_rule Vuln ID: V-72269
...
ls -al /etc/cron.* | grep aide
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040510 Rule ID: SV-86895r2_rule Vuln ID: V-72271
...
firewall-cmd --direct --get-rule ipv4 filter IN_public_allow
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040520 Rule ID: SV-86897r1_rule Vuln ID: V-72273
...
firewall-cmd --state
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040530 Rule ID: SV-86899r2_rule Vuln ID: V-72275
...
missing from or set to 'no' in the '/etc/ssh/sshd_config' file this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
grep pam_lastlog /etc/pam.d/postlogin-ac
grep -i printlastlog /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040540 Rule ID: SV-86901r1_rule Vuln ID: V-72277
...
find / -name '*.shosts'
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040550 Rule ID: SV-86903r1_rule Vuln ID: V-72279
...
find / -name shosts.equiv
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040600 Rule ID: SV-86905r1_rule Vuln ID: V-72281
...
grep nameserver /etc/resolv.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040610 Rule ID: SV-86907r1_rule Vuln ID: V-72283
...
/sbin/sysctl -a | grep net.ipv4.conf.all.accept_source_route
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040620 Rule ID: SV-86909r1_rule Vuln ID: V-72285
...
/sbin/sysctl -a | grep net.ipv4.conf.default.accept_source_route
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040630 Rule ID: SV-86911r1_rule Vuln ID: V-72287
...
/sbin/sysctl -a | grep net.ipv4.icmp_echo_ignore_broadcasts
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040640 Rule ID: SV-86913r2_rule Vuln ID: V-72289
...
/sbin/sysctl -a | grep 'net.ipv4.conf.default.accept_redirects'
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040650 Rule ID: SV-86915r2_rule Vuln ID: V-72291
...
grep 'net.ipv4.conf.default.send_redirects' /etc/sysctl.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040660 Rule ID: SV-86917r2_rule Vuln ID: V-72293
...
grep 'net.ipv4.conf.all.send_redirects' /etc/sysctl.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040670 Rule ID: SV-86919r1_rule Vuln ID: V-72295
...
ip link | grep -i promisc
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040680 Rule ID: SV-86921r2_rule Vuln ID: V-72297
...
postconf -n smtpd_client_restrictions
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040690 Rule ID: SV-86923r1_rule Vuln ID: V-72299
...
yum list installed lftpd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040700 Rule ID: SV-86925r1_rule Vuln ID: V-72301
...
yum list installed tftp-server
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040710 Rule ID: SV-86927r2_rule Vuln ID: V-72303
...
grep -i x11forwarding /etc/ssh/sshd_config
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040720 Rule ID: SV-86929r1_rule Vuln ID: V-72305
...
grep server_arge /etc/xinetd.d/tftp
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040730 Rule ID: SV-86931r2_rule Vuln ID: V-72307
...
yum group list installed "X Window System"
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040740 Rule ID: SV-86933r1_rule Vuln ID: V-72309
...
/sbin/sysctl -a | grep net.ipv4.ip_forward
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040750 Rule ID: SV-86935r3_rule Vuln ID: V-72311
...
cat /etc/fstab | grep nfs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040800 Rule ID: SV-86937r1_rule Vuln ID: V-72313
...
grep private /etc/snmp/snmpd.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040810 Rule ID: SV-86939r1_rule Vuln ID: V-72315
If the 'firewalld' package is not installed, ask the System Administrator (SA) if another firewall application 
(such as iptables) is installed. If an application firewall is not installed, this is a finding.
...
If 'firewalld' is not active, determine whether 'tcpwrappers' is being used by checking whether the 'hosts.allow' and 'hosts.deny' 
files are empty with the following commands:
...
If 'firewalld' and 'tcpwrappers' are not installed, configured, and active, ask the SA if another access control program 
(such as iptables) is installed and active. Ask the SA to show that the running configuration grants or denies access to 
specific hosts or services.
If 'firewalld' is active and is not configured to grant access to specific hosts and 'tcpwrappers' is not configured to 
grant or deny access to specific hosts, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
systemctl status firewalld
firewall-cmd --get-default-zone
firewall-cmd --list-all --zone=public
...
ls -al /etc/hosts.deny
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040820 Rule ID: SV-86941r1_rule Vuln ID: V-72317
...
is documented with the ISSO. If 'libreswan' is installed, 'IPsec' is active, and an undocumented tunnel is active, this is a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
yum list installed libreswan
systemctl status ipsec
grep -i conn /etc/ipsec.conf
grep -i conn /etc/ipsec.d/*.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040830 Rule ID: SV-86943r1_rule Vuln ID: V-72319
...
/sbin/sysctl -a | grep net.ipv6.conf.all.accept_source_route
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-041001 Rule ID: SV-87041r2_rule Vuln ID: V-72417
...
yum list installed authconfig-gtk
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-041002 Rule ID: SV-87051r2_rule Vuln ID: V-72427
...
grep services /etc/sssd/sssd.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-041003 Rule ID: SV-87057r2_rule Vuln ID: V-72433
...
cert_policy =ca, ocsp_on, signature;
cert_policy =ca, ocsp_on, signature;
There should be at least three lines returned. All lines must match the example output; specifically that 'oscp_on' 
must be included in the 'cert_policy' line.
If 'oscp_on' is present in all 'cert_policy' lines, this is not a finding."
echo "-------------------------------------------------------------------------------------------------------------------"
grep cert_policy /etc/pam_pkcs11/pam_pkcs11.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-041004 Rule ID: SV-87059r2_rule Vuln ID: V-72435
...
authconfig --test | grep -i smartcard
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010081 Rule ID: SV-87807r2_rule Vuln ID: V-73155
...
grep -i lock-delay /etc/dconf/db/local.d/locks/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010082 Rule ID: SV-87809r2_rule Vuln ID: V-73157
...
grep -i idle-delay /etc/dconf/db/local.d/locks/*
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-010119 Rule ID: SV-87811r2_rule Vuln ID: V-73159
...
grep pwquality /etc/pam.d/passwd
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-021021 Rule ID: SV-87813r1_rule Vuln ID: V-73161
...
more /etc/fstab | grep nfs
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030321 Rule ID: SV-87815r2_rule Vuln ID: V-73163
...
grep -i network_failure_action /etc/audisp/audisp-remote.conf
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030871 Rule ID: SV-87817r2_rule Vuln ID: V-73165
Verify the operating system must generate audit records for all account creations, modifications, disabling, and 
...
grep /etc/group /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030872 Rule ID: SV-87819r2_rule Vuln ID: V-73167
Verify the operating system must generate audit records for all account creations, modifications, disabling, and 
termination events that affect '/etc/gshadow'.
Check the auditing rules in '/etc/audit/audit.rules' with the following command:
...
grep /etc/gshadow /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030873 Rule ID: SV-87823r2_rule Vuln ID: V-73171
Verify the operating system must generate audit records for all account creations, modifications, disabling, and 
termination events that affect /etc/shadow.
Check the auditing rules in '/etc/audit/audit.rules' with the following command:
...
grep /etc/shadow /etc/audit/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-030874 Rule ID: SV-87825r3_rule Vuln ID: V-73173
Verify the operating system must generate audit records for all account creations, modifications, disabling, and 
termination events that affect /etc/opasswd.
...
grep /etc/security/opasswd /etc/audit/rules.d/audit.rules
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-040641 Rule ID: SV-87827r2_rule Vuln ID: V-73175
...
/sbin/sysctl -a | grep 'net.ipv4.conf.all.accept_redirects'
echo "___________________________________________________________________________________________________________________"
echo "STIG ID: RHEL-07-041010 Rule ID: SV-87829r1_rule Vuln ID: V-73177
